...
class OrganizationSelectorView(generic.TemplateView):
    template_name = "organization_selector.html"
...
class DashboardView(generic.DetailView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if orga is None:
            return HttpResponseRedirect(reverse('app:organization-selector'))
...
class OrganizationCreateView(generic.CreateView):
    template_name = "organization_create_or_update.html"
    model = Organization
    form_class = OrganizationForm
    success_url = reverse_lazy("app:organization-list")
...
class TaxRateListView(RestrictToSelectedOrganizationQuerySetMixin,
                      generic.ListView):
    template_name = "tax_rate_list.html"
    model = TaxRate
...
class TaxRateCreateView(AutoSetSelectedOrganizationMixin,
                        generic.CreateView):
    template_name = "tax_rate_create_or_update.html"
    model = TaxRate
    form_class = TaxRateForm
    success_url = reverse_lazy("app:tax_rate-list")
...
class PaymentUpdateView(generic.UpdateView):
    template_name = "payment_create_or_update.html"
    model = Payment
    ...
    def get_success_url(self):
        ...
        if isinstance(related_obj, Invoice):
            return reverse("app:invoice-detail", args=[related_obj.pk])
        elif isinstance(related_obj, Bill):
            return reverse("app:bill-detail", args=[related_obj.pk])
...
class PaymentDeleteView(generic.DeleteView):
    template_name = "delete_entity.html"
    model = Payment
    success_url = reverse_lazy('app:invoice-list')
...
class EstimateCreateView(AutoSetSelectedOrganizationMixin,
                         AbstractSaleCreateUpdateMixin,
                         generic.CreateView):
    template_name = "bill_create_or_update.html"
    model = Estimate
    form_class = EstimateForm
    formset_class = EstimateLineFormSet
    success_url = reverse_lazy("app:estimate-list")
...
class EstimateUpdateView(AutoSetSelectedOrganizationMixin,
                         AbstractSaleCreateUpdateMixin,
                         generic.UpdateView):
    template_name = "estimate_create_or_update.html"
    model = Estimate
    form_class = EstimateForm
    formset_class = EstimateLineFormSet
    success_url = reverse_lazy("app:estimate-list")
...
class EstimateDetailView(AbstractSaleDetailMixin,
                         generic.DetailView):
    template_name = "estimate_detail.html"
    model = Estimate
    context_object_name = "estimate"

    def get_success_url(self):
        return reverse('app:estimate-detail', args=[self.object.pk])
...
class InvoiceCreateView(AutoSetSelectedOrganizationMixin,
                        AbstractSaleCreateUpdateMixin,
                        generic.CreateView):
    template_name = "invoice_create_or_update.html"
    model = Invoice
...
class InvoiceDetailView(PaymentFormMixin,
    ...
    def get_success_url(self):
        return reverse('app:invoice-detail', args=[self.object.pk])
...
class BillCreateView(AutoSetSelectedOrganizationMixin,
    ...
    success_url = reverse_lazy("app:bill-list")
...
class BillDetailView(PaymentFormMixin,
    ...
    def get_success_url(self):
        return reverse('app:bill-detail', args=[self.object.pk])\
...
class ExpenseClaimListView(RestrictToSelectedOrganizationQuerySetMixin,
                           SaleListQuerySetMixin,
                           generic.ListView):
    template_name = "expense_claim_list.html"
    model = ExpenseClaim
...
class ExpenseClaimCreateView(AutoSetSelectedOrganizationMixin,
                             AbstractSaleCreateUpdateMixin,
                             generic.CreateView):
    template_name = "expense_claim_create_or_update.html"
    model = ExpenseClaim
...
class ExpenseClaimDetailView(PaymentFormMixin,
                             AbstractSaleDetailMixin,
                             generic.DetailView):
    template_name = "expense_claim_detail.html"
    model = ExpenseClaim
